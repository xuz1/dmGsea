...
probe.p$p[1:5000]=probe.p$p[1:5000]/10000
...
gsRank(stats=stats,gSetName="KEGG",scoreType="std",outfile="gs9",nperm=1e4,ncore=50)
#enrichment of genes with higher statistics
#stats=sort(abs(stats),decr=TRUE)
#gsRank(stats=stats,gSetName="KEGG",scoreType="std",outfile="gs10",nperm=1e4,ncore=50)
...
Ranking-Based or functional class scoring (FCS) GSEA, ranks all genes in a dataset based on a continuous metric (e.g., P-value, fold change,
