...
#significant CpGs
        if(!is.null(nTopProbe)){sig.cpg=cpg.p$Name[order(cpg.p$p,decreasing = FALSE)][1:nTopProbe]}else{
...
#main function
gsProbe<-function(probe.p,FDRthre=0.05,nTopProbe=NULL,sigProbe=NULL,allProbe=NULL,
